	...
	case'upgrade':
		if ($_POST)
		{
			...
			else
			{
				...
				$Qry9 = "INSERT INTO `$_POST[prefix]config` (`config_name` ,`config_value`)VALUES ('lang', 'utf8');";
				...
				$Qry19 = "INSERT INTO `$_POST[prefix]config` (`config_name`, `config_value`) VALUES ('VERSION', '2.9.4');";
