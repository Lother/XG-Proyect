...
$QryInsertConfig    .= "('close_reason'          , '‧n este momento el servidor se encuentra cerrado!'), ";
...
$QryTablePlanets    .= "`name` varchar(255) character set utf8 default '母星', ";
...
$QryTableUsers      .= "`darkmatter` int(11) NOT NULL default '100', ";
