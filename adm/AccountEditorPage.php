	...
	case'resources':
		...
		if(is_numeric($id) && is_numeric($metal) && is_numeric($cristal) && is_numeric($deut) && is_numeric($dark) && is_numeric($id_dark))
		{
			if ($_POST['add'])
			{
				...
				$Name	=	$lang['log_moree'];
				$parse['display']	=	'<tr><th colspan="2"><font color=lime>'.$lang['ad_resources_add_sucess'].'</font></th></tr>';
			}
			elseif ($_POST['delete'])
			{
				$QryUpdatePlanet  = "UPDATE {{table}} SET ";
				...
				$parse['display']	=	'<tr><th colspan="2"><font color=lime>'.$lang['ad_resources_delete_sucess'].'</font></th></tr>';
			}
		...
		if($_POST)
		{
				...
				is_numeric($battleship) && is_numeric($supernova))
			{
				if ($_POST['add'])
				{
					...
					$Name	=	$lang['log_moree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_ships_add_sucess'].'</font></th></tr>';
				}
				elseif ($_POST['delete'])
				{
					$QryUpdatePlanet  = "UPDATE {{table}} SET ";
					...
					$Name	=	$lang['log_nomoree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_ships_delete_sucess'].'</font></th></tr>';
				}
		...
		if ($_POST)
		{
				...
				is_numeric($interceptor_misil) && is_numeric($interplanetary_misil) && is_numeric($planet_protector))
			{
				if ($_POST['add'])
				{
					...
					$Name	=	$lang['log_moree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_defenses_add_sucess'].'</font></th></tr>';
				}
				elseif ($_POST['delete'])
				{
					$QryUpdatePlanet  = "UPDATE {{table}} SET ";
					...
					$Name	=	$lang['log_nomoree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_defenses_delete_sucess'].'</font></th></tr>';
				}
		...
		if ($_POST)
		{
				...
				is_numeric($phalanx) && is_numeric($sprungtor))
			{
				...
				if ($_POST['add'])
				{
					...
					$Name	=	$lang['log_moree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_buildings_add_sucess'].'</font></th></tr>';
				}
				elseif ($_POST['delete'])
				{
					$QryUpdatePlanet  = "UPDATE {{table}} SET ";
					...
					$Name	=	$lang['log_nomoree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_buildings_delete_sucess'].'</font></th></tr>';
				}
		...
		if ($_POST)
		{
				...
				is_numeric($buster_tech)&& is_numeric($intergalactic_tech) && is_numeric($expedition_tech) && is_numeric($graviton_tech))
			{
				...
				if ($_POST['add'])
				{
					...
					$Name	=	$lang['log_moree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_research_add_sucess'].'</font></th></tr>';
				}
				elseif ($_POST['delete'])
				{
					$QryUpdatePlanet  = "UPDATE {{table}} SET ";
					...
					$Name	=	$lang['log_nomoree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_research_delete_sucess'].'</font></th></tr>';
				}
	...
	case 'personal':
		...
		if ($_POST)
		{
			...
			else
			{
				...
				$parse['display']    =    '<tr><th colspan="3"><font color=lime>'.$lang['ad_personal_sucess'].'</font></th></tr>';
			}
		}
		...
		if ($_POST)
		{
				...
				is_numeric($rpg_bunker)&& is_numeric($rpg_raideur) && is_numeric($rpg_empereur))
			{
				...
				if ($_POST['add'])
				{
					...
					$Name	=	$lang['log_moree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_offi_add_sucess'].'</font></th></tr>';
				}
				elseif ($_POST['delete'])
				{
					$QryUpdatePlanet  = "UPDATE {{table}} SET ";
					...
					$Name	=	$lang['log_nomoree'];
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_offi_delete_sucess'].'</font></th></tr>';
				}
		...
		if ($_POST)
		{
			...
			if ($id != NULL)
			{
				...
				if ($delete != 'on')
				{
					...
					$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_pla_sucess'].'</font></th></tr>';
			...
			if ($id != NULL)
			{
				$QueryF	=	doquery("SELECT * FROM {{table}} WHERE `id` = '".$id."'", "alliance", true);
			 	...
			 	if ($QueryF)
			 	{
					...
					if ($i == 0)
						$parse['display']	=	'<tr><th colspan="3"><font color=lime>'.$lang['ad_ally_sucess'].'</font></th></tr>';
					else
						$parse['display']	=	$Error;
