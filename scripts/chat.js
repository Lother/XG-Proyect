...
var x_object2 = null;
	...
	x_object2.open("POST","class.chat_msg.php",true);
	x_object2.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
	x_object2.send("ally_id="+ally_id.value);
